...
int main() {
	...
	while (keepRunning == 1) {
		...
		do {
			...
			catch (DivideByZeroException) // catches user input for 0 in the denominator of a
			{
		...
		do {
			...
			catch (DivideByZeroException) // catches user input for 0 in the denominator of b
			{
				cout << "Exception occured: Entered a zero in the denominator. Please try again." << endl;
			}
		...
		catch (DivideByZeroException) // catches if it tries to divide by zero
		{
		...
		catch (DivideByZeroException) // catches 0 in denominator if operation ends with a 0 in denominator
		{
		...
		catch (DivideByZeroException) // catches 0 in the denominator of the reciprocal of a
		{
			cout << "Reciprocal of ";
			a.printRat();
		...
		catch (DivideByZeroException) // catches 0 in the denominator of the reciprocal of b
		{
			cout << "Reciprocal of ";
			b.printRat();
			cout << " resulted in denominator of 0." << endl;
